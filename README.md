# 17.8.2022 (1)
### Fortschritt
In unserer ersten Stunde mussten wir uns ersteinmal ein wenig orientieren und haben dann zunächst unseren GitHub-Account erstellt. Danach schauten wir uns alte Projekte anderer Schüler an, um einen ersten Eindruck zu bekommen. Schließlich fingen wir dann damit an, uns Markdown anzuschauen und anzueignen. 
...
# 23.08.22 (2)
### Fortschritt 
Heute sind wir der Projektfindung näher gekommen. Wir haben uns dazu entschieden, ein Java blockbasiertes 2-D Spiel in Greenfoot zu programmieren. Hierzu haben wir begonnen uns darüber zu informieren, wie Greenfoot aufgebaut ist und wie man dort coded. Außerdem haben wir noch ein wenig in Projekten ehemaliger Schüler gestöbert, um Inspiration zu sammelen und eine Vorschau zu bekommen, wie ein fertiges Projekt so aussehen könnte. 
...
# 24.08.2022 (3)
### Fortschritt 
In dieser Doppelstunde haben wir weiter in Greenfoot gearbeitet. Wir haben gelernt, einen Background in unserer Welt einzufügen und mehrere Objekte. Zudem können wir diesen Objekten nun Befehle erteilen (sie dazu bewgen sich zu bewegen, zu drehen usw.). Außerdem haben wir uns ein bereits erstelltes Szenario, das sogenannte "little crab" Szenario, angeguckt. Schlussendlich haben wir uns zwei Bücher über Java ausgeliehen, um dort das Arbeiten mit Java zu erlernen und weiterzukommen. 
...
# 31.08.2022 (5)
### Fortschritt
Da ich in der letzten Stunde nicht da war, habe ich ebenfalls mit dem "wombat"-Scenario gearbeitet. Ich habe allgemeine Interaktionen von Greenfoot-Objekten kennengelernt. Das heißt, ich habe erste Versuche mit den Methoden und ihren Parametern gemacht. (Einführung in Java mit Greenfoot Kapitel 1.1 - 1.6)
(David)
...
# 27.09.2022 (9)
### Fortschritt
Wir haben uns heute einen konkreten Plan für unser Projekt überlegt. Wir wollen ein Spiel programmieren, bei dem unser Hauptakteur Objekte einer anderen Klasse einsammeln muss und nochmals anderen Objekten ausweichen muss. Diese anderen Objekte wollen unseren Akteur fressen. So in etwa soll unser Spiel aussehen. Hat unser Akteur eine gewisse Anzahl an Objekten eingesammelt, dann kommt ein Levelaufstieg und mehr Feinde kommen hinzu. Es wird also immer schwieriger, je mehr Objekte unser Hauptaktur eingesammelt hat. 

# 28.09.2022 (10)
### Fortschritt
Heute habe ich ein neues Szenario erstellt, das "Spiel-Szeanrio". Darin habe ich Methoden programmiert, die zu unserer Spielidee passen. Insgesamt habe ich 3 Actors und eine neue Welt programmiert. Ich habe sehr unterschiedliche Methoden benutzt. (Selma)

# 5.10.2022 (11)
### Fortschritt
Ich habe heute die Tastertursteuerung für einen Actor programmiert. Das Objekt kann sich auch nach oben, unten, rechts und links bewegen. Außerdem habe ich mir Gedanken über Themen des spiels gemacht. (David)
